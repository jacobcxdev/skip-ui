...
/**
 * CompositionLocal providing the item position for standalone drag handle modifiers.
 * Provided automatically by [ReorderableCollectionItem].
 */
val LocalReorderableItemPosition = staticCompositionLocalOf<(() -> Offset)?> { null }
...
internal fun ReorderableCollectionItem(
    ...
    val itemPositionProvider: () -> Offset = { itemPosition }

    CompositionLocalProvider(LocalReorderableItemPosition provides itemPositionProvider) {
        Box(
